    ...
    screenOptions={({route}) => ({
      tabBarIcon: ({focused}) => {
        ...
        if (route.name === 'Trang chủ') {
          ...
          return (
            <Icon name={iconName}  type="ionicon" color={iconName = focused ? 'rgb(235, 217, 21)' : 'gray' }/>
            );
          },
      })}
      barStyle={{backgroundColor: 'black'}} tabBarOptions={{activeTintColor:'rgb(235, 217, 21)',inactiveTintColor:'gray',style:{backgroundColor:'black'}}}
      activeColor={'black'}>
      <Tab.Screen name={'Trang chủ'} component={HomeScreen} />
      <Tab.Screen name={'Khám phá'} component={HistoryScreen} />
